			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlatb16 = glstate_matrix_projection[3].w==0.0;
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat17 = (-u_xlat3.w) + vs_TEXCOORD1.z;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xy = clamp(u_xlat1.xy, 0.0, 1.0);
					    u_xlat1.x = u_xlat1.y * u_xlat1.x;
					    u_xlat5.x = u_xlat0.w * u_xlat1.x + -0.00100000005;
					    u_xlatb5 = u_xlat5.x<0.0;
					    if(((int(u_xlatb5) * int(0xffffffffu)))!=0){discard;}
					    u_xlat5.x = _GlowOffset * _ScaleRatioB;
					    u_xlat5.x = u_xlat5.x * 0.5;
					    u_xlat5.x = (-u_xlat5.x) * vs_TEXCOORD1.y + u_xlat9.x;
					    u_xlatb9 = u_xlat5.x>=0.0;
					    u_xlat9.x = u_xlatb9 ? 1.0 : float(0.0);
					    u_xlat13 = _GlowOuter * _ScaleRatioB + (-_GlowInner);
					    u_xlat9.x = u_xlat9.x * u_xlat13 + _GlowInner;
					    u_xlat9.x = u_xlat9.x * 0.5;
					    u_xlat13 = u_xlat9.x * vs_TEXCOORD1.y + 1.0;
					    ...
					    u_xlat0.xyz = _GlowColor.xyz * u_xlat5.xxx + u_xlat0.xyz;
					    u_xlat0 = u_xlat0 * u_xlat1.xxxx;
					    SV_Target0 = u_xlat0 * vs_COLOR0.wwww;
					    return;
					}"
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat6 = u_xlat6 * vs_TEXCOORD1.y;
					    u_xlat6 = (-u_xlat6) * 0.5 + u_xlat8;
					    u_xlatb11 = u_xlat6>=0.0;
					    u_xlat11 = u_xlatb11 ? 1.0 : float(0.0);
					    u_xlat16 = _GlowOuter * _ScaleRatioB + (-_GlowInner);
					    u_xlat11 = u_xlat11 * u_xlat16 + _GlowInner;
					    u_xlat11 = u_xlat11 * vs_TEXCOORD1.y;
					    u_xlat16 = u_xlat11 * 0.5 + 1.0;
					    ...
					    u_xlat0.xyz = _GlowColor.xyz * vec3(u_xlat6) + u_xlat0.xyz;
					    u_xlat0 = u_xlat0 * u_xlat1.xxxx;
					    SV_Target0 = u_xlat0 * vs_COLOR0.wwww;
					    return;
					}"
