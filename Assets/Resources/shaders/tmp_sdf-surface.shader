			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat29 = (-unused_0_33.y) + unused_0_33.z;
					    u_xlat29 = u_xlat21 * u_xlat29 + unused_0_33.y;
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3.x = u_xlat18 * vs_TEXCOORD6.y;
					    ...
					    u_xlat6.w = u_xlat11.x * u_xlat6.w;
					    ...
					    u_xlat11.x = vs_TEXCOORD6.x + _BevelOffset;
					    u_xlat1.x = u_xlat3.w;
					    u_xlat1.y = u_xlat4.w;
					    u_xlat1.z = u_xlat2.w;
					    ...
					    u_xlat7 = texture(_BumpMap, vs_TEXCOORD0.zw);
					    ...
					    u_xlat26 = (-unused_0_31.y) + unused_0_31.z;
					    u_xlat26 = u_xlat3.x * u_xlat26 + unused_0_31.y;
					    u_xlatb3 = unity_ProbeVolumeParams.x==1.0;
					    if(u_xlatb3){
					        u_xlatb3 = unity_ProbeVolumeParams.y==1.0;
					        u_xlat11.xyz = vs_TEXCOORD5.yyy * unity_ProbeVolumeWorldToObject[1].xyz;
					        u_xlat11.xyz = unity_ProbeVolumeWorldToObject[0].xyz * vs_TEXCOORD5.xxx + u_xlat11.xyz;
					        u_xlat11.xyz = unity_ProbeVolumeWorldToObject[2].xyz * vs_TEXCOORD5.zzz + u_xlat11.xyz;
					        u_xlat11.xyz = u_xlat11.xyz + unity_ProbeVolumeWorldToObject[3].xyz;
					        u_xlat3.xyz = (bool(u_xlatb3)) ? u_xlat11.xyz : vs_TEXCOORD5.xyz;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3.x = (u_xlatb5) ? u_xlat3.x : (-u_xlat3.x);
					    u_xlatb3 = u_xlat3.x>=0.5;
					    u_xlat5.x = vs_TEXCOORD6.x + _BevelOffset;
					    u_xlat2.x = u_xlat4.w;
					    u_xlat2.y = u_xlat5.w;
					    u_xlat2.z = u_xlat3.w;
					    u_xlat2 = u_xlat5.xxxx + u_xlat2;
					    ...
					    u_xlat26 = u_xlat26 * vs_TEXCOORD6.y;
					    ...
					    u_xlat26 = (-unused_0_32.y) + unused_0_32.z;
					    u_xlat26 = u_xlat19 * u_xlat26 + unused_0_32.y;
					    ...
					    if(u_xlatb19){
					        ...
					        u_xlat5.xyz = unity_ProbeVolumeWorldToObject[2].xyz * vs_TEXCOORD5.zzz + u_xlat5.xyz;
					        u_xlat5.xyz = u_xlat5.xyz + unity_ProbeVolumeWorldToObject[3].xyz;
					        u_xlat5.xyz = (bool(u_xlatb19)) ? u_xlat5.xyz : vs_TEXCOORD5.xyz;
					        u_xlat5.xyz = u_xlat5.xyz + (-unity_ProbeVolumeMin.xyz);
					        u_xlat5.yzw = u_xlat5.xyz * unity_ProbeVolumeSizeInv.xyz;
					    ...
					    u_xlat8.x = u_xlat8.x * u_xlat16;
					    u_xlat8.x = exp2(u_xlat8.x);
					    u_xlat1.xyz = u_xlat3.xyw * u_xlat4.xyz;
					    u_xlat2.xyz = u_xlat4.xyz * _SpecColor.xyz;
					    u_xlat8.xyz = u_xlat8.xxx * u_xlat2.xyz;
					    SV_Target0.xyz = u_xlat1.xyz * u_xlat0.xxx + u_xlat8.xyz;
					    SV_Target0.w = u_xlat25;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = u_xlat11.xyz / u_xlat2.xxx;
					    u_xlat26 = (-unused_0_32.y) + unused_0_32.z;
					    u_xlat26 = u_xlat3.x * u_xlat26 + unused_0_32.y;
